...
`ls-id-backfill` re-attach too, whose own skill asks for a workbook: on a Notion row
this rule wins. Give a workbook to the person directly if they want one.
